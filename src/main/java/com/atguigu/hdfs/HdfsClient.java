...
public class HdfsClient {
    ...
    public void testPut() throws IOException {
        ...
        fs.copyFromLocalFile(false,false,new Path("E:\\tychema\\program\\testTXT\\sunwukong.txt"),new Path("hdfs://hadoop101/xiyou"));
    }
    @Test
    public void testGet() throws IOException {
        // 参数：1、是否删除原数据 2、源文件路径 3、目的文件路径 4、是否开启本地校验
        fs.copyToLocalFile(false,new Path("hdfs://hadoop101:8020/xiyou/huaguoshan"),new Path("E:\\tychema\\program\\testTXT"),false);
    }
    @Test
    public void testRM() throws IOException {
        //参数：1、路径 2、是否递归删除(空目录false非空目录true)
        fs.delete(new Path("hdfs://hadoop101:8020/xiyou/huaguoshan"),true);
    }
    @Test
    public void testVmOrRename() throws IOException {
        //参数：1、原路径 2、目的路径
        //既可以改名rename也可以移动mv
        fs.rename(new Path("hdfs://hadoop101:8020/xiyou/huaguoshan/word.txt"),new Path("hdfs://hadoop101:8020/xiyou/shuiliandong/word.txt"));
    }
    @Test
